        ...
        if (userAction == UserAction.DISPLAY_CLIENT_INFO) {
            ...
            for (Client client : clients) {
                ...
                if (clientAccount != null) {
                    System.out.println("Client Account Number: " + clientAccount.getAccount_Number());
                    System.out.println("Client Balance: " + clientAccount.getBalance());
                    System.out.println("Client CVV: " + clientAccount.getCVV());
                    System.out.println("Client Expiration Date: " + clientAccount.getExp_Date());
                    System.out.println("Client Account State: " + (clientAccount.isAccount_State() ? "Active" : "Closed"));
                } else {
